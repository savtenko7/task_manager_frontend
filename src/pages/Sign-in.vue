    ...
    <el-container>
      ...
      <el-main>
        <el-card class="login-card">
          <h3>Войти</h3>
          <el-form :model="formReg" @submit.prevent="loginUser" label-width="120px">
            ...
            <el-form-item label="Введите пароль">
              ...
              <div class="mb-4">
                    <el-button
                        ...
                        >
                        Редкий гость? Восстановим
                    </el-button>
                </div>
            </el-form-item>
            <el-form-item>
              <el-button type="primary" native-type="submit">Войти</el-button>
              <el-button type="primary" @click="redirectToSignUp">Пока нет аккаунта</el-button>
            </el-form-item>
          </el-form>
        </el-card>
      </el-main>
